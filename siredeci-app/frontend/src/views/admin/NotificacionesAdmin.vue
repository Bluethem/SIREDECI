      ...
      <section class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p class="text-sm text-slate-500 mt-1">
            Notificaciones internas sobre denuncias, reportes y eventos del sistema.
          </p>
        </div>
      </section>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col">
          ...
          <div class="flex-1 overflow-y-auto px-5 py-4 space-y-4 text-sm">
            <p class="text-slate-600 text-sm">
              Ajusta cómo deseas recibir las notificaciones internas del sistema.
            </p>
...
const cargarNotificaciones = async () => {
  try {
    ...
    console.error('Error al cargar notificaciones internas:', error)
...
const cargarConfig = async () => {
  try {
    ...
    console.error('Error al cargar configuración de notificaciones internas:', error)
  }
}
...
const guardarConfig = async () => {
  try {
    ...
    console.error('Error al guardar configuración de notificaciones internas:', error)
  } finally {
...
const marcarLeida = async (n) => {
  try {
    ...
    console.error('Error al marcar notificación interna como leída:', error)
  }
}
