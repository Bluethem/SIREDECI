# Guía de Inicialización del Proyecto SIREDECI
...
# Vuelidate o VeeValidate (validación de formularios)
...
ls -la
# Deberías ver: config/, manage.py, requirements.txt
```
...
### Paso 12: Configurar settings.py básico
...
### Paso 13: Crear settings de desarrollo y producción
...
```bash
cd ..
# Deberías estar en: siredeci/backend/
```
...
# Se inicia automáticamente o desde Services
```
...
## PARTE 4: Ejecutar Migraciones y Crear Superusuario

### Paso 1: Verificar que estás en el entorno virtual
...
### Paso 2: Verificar configuración de Django

```bash
# Probar configuración
python manage.py check

# Debería responder: System check identified no issues (0 silenced).
```
...
### Paso 5: Ejecutar el script de creación de tablas

```bash
# Copiar el script SQL a una ubicación accesible
# Luego ejecutarlo:
...
## PARTE 5: Ejecutar Ambos Proyectos
...
## PARTE 6: Scripts útiles en package.json
...
## PARTE 7: Configuración de Git

### Paso 1: Inicializar repositorio

```bash
# En la raíz del proyecto (siredeci/)
cd siredeci
git init
```
