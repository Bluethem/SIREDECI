...
('PER-00201', '45678901', 'Luis', 'Martínez Ruiz', 'luis.martinez@municipalidad.gob.pe', 'Técnico de Campo', '2021-02-01', 'Obras Civiles', 
 (SELECT id_area_responsable FROM AreaResponsable WHERE codigo_area = 'ARE-001'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-00201')),
 
('PER-00202', '56789012', 'Ana', 'Sánchez Vega', 'ana.sanchez@municipalidad.gob.pe', 'Supervisora de Limpieza', '2020-08-15', 'Servicios', 
 (SELECT id_area_responsable FROM AreaResponsable WHERE codigo_area = 'ARE-002'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-00202')),
...
('PER-00203', '67890123', 'Roberto', 'Fernández Castro', 'roberto.fernandez@municipalidad.gob.pe', 'Agente de Serenazgo', '2022-01-10', 'Seguridad', 
 (SELECT id_area_responsable FROM AreaResponsable WHERE codigo_area = 'ARE-003'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-00203')),
...
('PER-00204', '78901234', 'Patricia', 'Lovato Mendoza', 'patricia.lovato@municipalidad.gob.pe', 'Técnica Electricista', '2021-09-05', 'Electricidad', 
 (SELECT id_area_responsable FROM AreaResponsable WHERE codigo_area = 'ARE-005'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-00204'))
ON CONFLICT (codigo_personal) DO NOTHING;
...
INSERT INTO PersonalTelefono (id_personal, telefono, es_principal) VALUES
((SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00101'), '987654321', TRUE),
((SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00102'), '987654322', TRUE),
((SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00103'), '987654323', TRUE),
((SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00201'), '987654324', TRUE),
((SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00202'), '987654325', TRUE)
ON CONFLICT DO NOTHING;
...
('CIU-10001', '11223344', 'Pedro', 'González Ramos', 'ciudadano1@email.com', 'Av. Los Álamos 123', '2018-05-10',
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10001')),
('CIU-10002', '22334455', 'Laura', 'Mendoza Silva', 'ciudadano2@email.com', 'Jr. Las Flores 456', '2019-08-15',
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10002')),
('CIU-10003', '33445566', 'Jorge', 'Vargas Torres', 'ciudadano3@email.com', 'Av. Primavera 789', '2020-02-20',
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10003'))
...
INSERT INTO CiudadanoTelefono (id_ciudadano, telefono, es_principal) VALUES
((SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10001'), '999111222', TRUE),
((SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10002'), '999222333', TRUE),
((SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10003'), '999333444', TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO Ubicacion (codigo_ubicacion, latitud, longitud, direccion, referencia, distrito, codigo_postal) VALUES
...
INSERT INTO Denuncia (codigo_denuncia, titulo, descripcion, estado, prioridad, numero_seguimiento, id_ciudadano, id_categoria, id_ubicacion) VALUES
('DEN-2025-00001', 'Bache grande en Av. Arequipa', 'Existe un bache de aproximadamente 50cm de diámetro que representa un peligro para los vehículos', 'Registrado', 'Alta', 'SEG-ABC123456',
 (SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10001'),
 (SELECT id_categoria FROM Categoria WHERE codigo_categoria = 'CAT-001'),
 (SELECT id_ubicacion FROM Ubicacion WHERE codigo_ubicacion = 'UBI-00001'))
ON CONFLICT (codigo_denuncia) DO NOTHING;

-- Denuncia 2: Basura (En revisión)
INSERT INTO Denuncia (codigo_denuncia, titulo, descripcion, fecha_registro, estado, prioridad, numero_seguimiento, id_ciudadano, id_categoria, id_ubicacion) VALUES
('DEN-2025-00002', 'Acumulación de basura', 'Hace 3 días que no pasa el camión recolector y la basura se acumula', CURRENT_TIMESTAMP - INTERVAL '2 days', 'En revisión', 'Urgente', 'SEG-DEF789012',
 (SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10002'),
 (SELECT id_categoria FROM Categoria WHERE codigo_categoria = 'CAT-002'),
 (SELECT id_ubicacion FROM Ubicacion WHERE codigo_ubicacion = 'UBI-00002'))
ON CONFLICT (codigo_denuncia) DO NOTHING;
...
('DEN-2025-00003', 'Poste de luz sin funcionar', 'El poste de luz de la cuadra lleva 5 días apagado', CURRENT_TIMESTAMP - INTERVAL '3 days', 'Asignado', 'Media', 'SEG-GHI345678',
 (SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10003'),
 (SELECT id_categoria FROM Categoria WHERE codigo_categoria = 'CAT-003'),
 (SELECT id_ubicacion FROM Ubicacion WHERE codigo_ubicacion = 'UBI-00003'))
ON CONFLICT (codigo_denuncia) DO NOTHING;
...
('DEN-2025-00004', 'Falta de patrullaje en la zona', 'No se observa presencia de serenazgo en horas de la noche', CURRENT_TIMESTAMP - INTERVAL '7 days', 'Resuelta', 'Alta', 'SEG-JKL901234',
 (SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10001'),
 (SELECT id_categoria FROM Categoria WHERE codigo_categoria = 'CAT-004'),
 (SELECT id_ubicacion FROM Ubicacion WHERE codigo_ubicacion = 'UBI-00004'))
ON CONFLICT (codigo_denuncia) DO NOTHING;
...
('DEN-2025-00005', 'Parque descuidado', 'El parque necesita mantenimiento urgente, el césped está muy alto', CURRENT_TIMESTAMP - INTERVAL '5 days', 'En proceso', 'Baja', 'SEG-MNO567890',
 (SELECT id_ciudadano FROM Ciudadano WHERE codigo_ciudadano = 'CIU-10002'),
 (SELECT id_categoria FROM Categoria WHERE codigo_categoria = 'CAT-005'),
 (SELECT id_ubicacion FROM Ubicacion WHERE codigo_ubicacion = 'UBI-00005'))
ON CONFLICT (codigo_denuncia) DO NOTHING;
...
INSERT INTO Seguimiento (codigo_seguimiento, estado_anterior, estado_nuevo, comentario, id_denuncia, id_usuario) VALUES
('SEG-00001', NULL, 'Registrado', 'Denuncia registrada exitosamente en el sistema',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00001'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10001'))
ON CONFLICT (codigo_seguimiento) DO NOTHING;

-- Seguimiento Denuncia 2
INSERT INTO Seguimiento (codigo_seguimiento, estado_anterior, estado_nuevo, fecha_hora, comentario, id_denuncia, id_usuario) VALUES
('SEG-00002', NULL, 'Registrado', CURRENT_TIMESTAMP - INTERVAL '2 days', 'Denuncia registrada exitosamente en el sistema',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00002'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10002')),
...
('SEG-00004', NULL, 'Registrado', CURRENT_TIMESTAMP - INTERVAL '3 days', 'Denuncia registrada exitosamente en el sistema',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00003'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10003')),
('SEG-00005', 'Registrado', 'En revisión', CURRENT_TIMESTAMP - INTERVAL '2 days', 'Denuncia en revisión por el área responsable',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00003'),
 (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-00001')),
...
INSERT INTO Asignacion (codigo_asignacion, fecha_asignacion, motivo_asignacion, id_denuncia, id_personal_asignado, id_personal_asignador) VALUES
('ASG-00001', CURRENT_TIMESTAMP - INTERVAL '1 day', 'Asignación por especialidad en alumbrado público',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00003'),
 (SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00204'),
 (SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00101'))
ON CONFLICT (codigo_asignacion) DO NOTHING;

-- Asignación Denuncia 4 (Resuelta)
INSERT INTO Asignacion (codigo_asignacion, fecha_asignacion, motivo_asignacion, es_activa, fecha_finalizacion, id_denuncia, id_personal_asignado, id_personal_asignador) VALUES
('ASG-00002', CURRENT_TIMESTAMP - INTERVAL '7 days', 'Asignación a agente de serenazgo', FALSE, CURRENT_TIMESTAMP - INTERVAL '2 days',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00004'),
 (SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00203'),
 (SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00103'))
ON CONFLICT (codigo_asignacion) DO NOTHING;

-- Asignación Denuncia 5
INSERT INTO Asignacion (codigo_asignacion, fecha_asignacion, motivo_asignacion, id_denuncia, id_personal_asignado, id_personal_asignador) VALUES
('ASG-00003', CURRENT_TIMESTAMP - INTERVAL '4 days', 'Asignación para mantenimiento de área verde',
 (SELECT id_denuncia FROM Denuncia WHERE codigo_denuncia = 'DEN-2025-00005'),
 (SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00202'),
 (SELECT id_personal FROM PersonalMunicipal WHERE codigo_personal = 'PER-00102'))
ON CONFLICT (codigo_asignacion) DO NOTHING;
...
INSERT INTO Tramitacion (codigo_tramitacion, fecha_inicio, fecha_finalizacion, accion_realizada, observaciones, estado_tramitacion, id_asignacion) VALUES
('TRA-00001', CURRENT_TIMESTAMP - INTERVAL '6 days', CURRENT_TIMESTAMP - INTERVAL '2 days',
 ...
 'Finalizado',
 (SELECT id_asignacion FROM Asignacion WHERE codigo_asignacion = 'ASG-00002'))
ON CONFLICT (codigo_tramitacion) DO NOTHING;

-- Tramitación Denuncia 5 (En proceso)
INSERT INTO Tramitacion (codigo_tramitacion, fecha_inicio, accion_realizada, observaciones, costo_estimado, estado_tramitacion, id_asignacion) VALUES
('TRA-00002', CURRENT_TIMESTAMP - INTERVAL '3 days',
 ...
 350.00,
 'En proceso',
 (SELECT id_asignacion FROM Asignacion WHERE codigo_asignacion = 'ASG-00003'))
ON CONFLICT (codigo_tramitacion) DO NOTHING;
...
INSERT INTO Resolucion (codigo_resolucion, fecha_resolucion, tipo_resolucion, descripcion_resolucion, tiempo_total_horas, calificacion_ciudadano, comentario_ciudadano, id_tramitacion) VALUES
('RES-00001', CURRENT_TIMESTAMP - INTERVAL '2 days', 'Resuelta',
 ...
 (SELECT id_tramitacion FROM Tramitacion WHERE codigo_tramitacion = 'TRA-00001'))
...
INSERT INTO ConfiguracionNotificacion (codigo_configuracion, recibir_email, recibir_sms, recibir_push, frecuencia_resumen, id_usuario) VALUES
('CFG-00001', TRUE, FALSE, TRUE, 'Inmediato', (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10001')),
('CFG-00002', TRUE, TRUE, TRUE, 'Diario', (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10002')),
('CFG-00003', TRUE, FALSE, FALSE, 'Semanal', (SELECT id_usuario FROM Usuario WHERE codigo_usuario = 'USR-10003'))
